...
import homework.playground.processors.RiadableProcessor;

public class RideableProcessorRunner {
    public static void main(String[] args) {
        RiadableProcessor riadableProcessor = new RiadableProcessor();
        ...
        riadableProcessor.runRiadable(rideableCar);
        riadableProcessor.runRiadable(rideableMoped);
        riadableProcessor.runRiadable(rideableMotorbike);
        riadableProcessor.runRiadable(vehicleMoped);
        riadableProcessor.runRiadable(vehicleCar);
        riadableProcessor.runRiadable(vehicleMotorbike);
        riadableProcessor.runRiadable(aCar);
        riadableProcessor.runRiadable(aMoped);
        riadableProcessor.runRiadable(aMotorbike);
        riadableProcessor.runRiadable(anonymousVehicle);
        riadableProcessor.runRiadable(anonymousRideable);
